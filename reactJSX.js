...
function Car(props) {
    ...
    //     </div>
    // )
    return e('div', { className: "card", key: '1' }, e("div", { className: "card-img", key: '2' }, [e('img', { src: props.car.img, alt: props.car.name, key: '3' }), e('h3', { key: '4' }, props.car.name), e('p', { key: '5' }, props.car.price)]));
}
